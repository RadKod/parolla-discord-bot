import { ActionRowBuilder, Client, Collection, EmbedBuilder, Events, GatewayIntentBits, InteractionCollector, Partials, REST, Routes, SelectMenuBuilder } from "discord.js";
...
(async () => {
    try {
        ...
        await rest.put(Routes.applicationGuildCommands(CLIENT_ID, GUILD_ID), { body: client.slashCommands.map(command => command.command.toJSON()) });
